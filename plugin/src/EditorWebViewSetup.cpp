...
juce::WebBrowserComponent::Options buildMainWebViewOptions(TONE3000Editor* editor) {
  return juce::WebBrowserComponent::Options{}
      ...
      .withOptionsFrom(editor->inputLevelRRelay)
      .withOptionsFrom(editor->outputLevelRelay)
      .withOptionsFrom(editor->outputLevelRRelay)
      .withOptionsFrom(editor->inputLinkedRelay)
      .withOptionsFrom(editor->outputLinkedRelay)
